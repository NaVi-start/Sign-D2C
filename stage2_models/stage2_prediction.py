...
from stage2_models.model import Model
...
def validate_on_data(model: Model,
    ...
    with torch.no_grad():
        ...
        for valid_batch in iter(valid_iter):
            ...
            output, encoder_output, preds_x, mask_list = model(is_train=False, trg_input=batch.trg_input[:, :, :150], trg_mask=batch.trg_mask, lengths=batch.trg_lengths)
